...
import org.openpnp.machine.reference.feeder.SolenoidSpringDragFeeder;
...
/**
 * Configuration wizard for {@link SolenoidSpringDragFeeder}.
 *
 * Identical to {@link ReferenceDragFeederConfigurationWizard} but adds a
 * "Backoff Speed %" field in the General Settings panel. This controls how
 * slowly the head backs off after the drag, giving the spring time to retract
 * the pin.
 */
@SuppressWarnings("serial")
public class SolenoidSpringDragFeederConfigurationWizard
        extends AbstractReferenceFeederConfigurationWizard {
    private final SolenoidSpringDragFeeder feeder;
    ...
    // Solenoid-specific: backoff speed control
    private JLabel lblBackoffSpeed;
    private JTextField textFieldBackoffSpeed;

    public SolenoidSpringDragFeederConfigurationWizard(SolenoidSpringDragFeeder feeder) {
        super(feeder);
        this.feeder = feeder;
        ...
        // Extra row (8 total) compared to ReferenceDragFeeder (6 rows) for Backoff Speed
        ...
        // Solenoid-specific: backoff speed field
        lblBackoffSpeed = new JLabel("Backoff Speed %");
        panelGeneral.add(lblBackoffSpeed, "2, 8, right, default");

        textFieldBackoffSpeed = new JTextField();
        panelGeneral.add(textFieldBackoffSpeed, "4, 8");
        textFieldBackoffSpeed.setColumns(5);
    ...
    public void createBindings() {
        ...
        // Solenoid-specific: bind backoff speed field
        addWrappedBinding(feeder, "backoffSpeed", textFieldBackoffSpeed, "text", percentConverter);
        ...
        // Solenoid-specific: decorate backoff speed field
        ComponentDecorators.decorateWithAutoSelectAndLengthConversion(textFieldBackoffSpeed);
    ...
    private Action confirmSelectTemplateImageAction = new AbstractAction("Confirm") {
        ...
        public void actionPerformed(ActionEvent arg0) {
            UiUtils.messageBoxOnException(() -> {
                ...
                if (image == null) {
                    MessageBoxes.errorBox(SolenoidSpringDragFeederConfigurationWizard.this,
                            "No Image Selected",
